...
: "${EXPORT_PATH:="$HOME/exports/visgym_matchstick_rotation_long_no_kl"}"
...
uv run --isolated --extra fsdp \
  ...
  trainer.run_name="matchstick_rotation_easy_full_long_no_kl" \
  ...
  trainer.ckpt_path="$HOME/ckpts/visgym_matchstick_rotation_long_no_kl" \
